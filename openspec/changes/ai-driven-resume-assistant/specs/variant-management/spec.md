...
The system SHALL allow creation of role-specific resume variants derived from a base resume profile and one or more `JobProfile` instances.
...
The system SHALL support listing and retrieving existing resume variants for a given user and base profile.
